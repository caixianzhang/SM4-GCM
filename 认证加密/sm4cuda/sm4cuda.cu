	 8 * 4 + 0 * 128,  9 * 4 + 0 * 128, 10 * 4 + 0 * 128, 11 * 4 + 0 * 128, 12 * 4 + 0 * 128, 13 * 4 + 0 * 128, 14 * 4 + 0 * 128, 15 * 4 + 0 * 128, \
	16 * 4 + 1 * 128, 17 * 4 + 1 * 128, 18 * 4 + 1 * 128, 19 * 4 + 1 * 128, 20 * 4 + 1 * 128, 21 * 4 + 1 * 128, 22 * 4 + 1 * 128, 23 * 4 + 1 * 128, \
	24 * 4 + 2 * 128, 25 * 4 + 2 * 128, 26 * 4 + 2 * 128, 27 * 4 + 2 * 128, 28 * 4 + 2 * 128, 29 * 4 + 2 * 128, 30 * 4 + 2 * 128, 31 * 4 + 2 * 128, \
};
uint32_t linear_table_three[32] = {
	 3 * 4 + 0 * 128,  7 * 4 + 0 * 128, 11 * 4 + 0 * 128, 15 * 4 + 0 * 128, 19 * 4 + 0 * 128, 23 * 4 + 0 * 128, 27 * 4 + 0 * 128, 31 * 4 + 0 * 128, \
	 0 * 4 + 1 * 128,  4 * 4 + 1 * 128,  8 * 4 + 1 * 128, 12 * 4 + 1 * 128, 16 * 4 + 1 * 128, 20 * 4 + 1 * 128, 24 * 4 + 1 * 128, 28 * 4 + 1 * 128, \
	 1 * 4 + 2 * 128,  5 * 4 + 2 * 128,  9 * 4 + 2 * 128, 13 * 4 + 2 * 128, 17 * 4 + 2 * 128, 21 * 4 + 2 * 128, 25 * 4 + 2 * 128, 29 * 4 + 2 * 128, \
	 2 * 4 + 3 * 128,  6 * 4 + 3 * 128, 10 * 4 + 3 * 128, 14 * 4 + 3 * 128, 18 * 4 + 3 * 128, 22 * 4 + 3 * 128, 26 * 4 + 3 * 128, 30 * 4 + 3 * 128, \
};
	...
	uint8_t dev_output[PARTICLE_SIZE / STREAM_SIZE])
{
	...
	//以对齐合并访存的模式从全局内存读取IV
	{
		uint32_t *read = (uint32_t *)(dev_iv + dev_offset);
		uint32_t *write = (uint32_t *)(matrix + share_offset);
...

	{
...

		{
			...
			//填写本线程密文输出起始地址(矩形存储模式)
			uint8_t *read = rw_matrix;

			*(uint32_t *)(tidCTR + 0 * 4) = *(uint32_t *)(read + 0 * 32 * 4);
			*(uint32_t *)(tidCTR + 1 * 4) = *(uint32_t *)(read + 1 * 32 * 4);
			*(uint32_t *)(tidCTR + 2 * 4) = *(uint32_t *)(read + 2 * 32 * 4);
	...
	
	{
		...
		for (int i = 0; i < STREAM_SIZE; i++)
		{
			...
			cudaMemcpyAsync(\
				...
				tempiv + i * (PARTICLE_SIZE / STREAM_SIZE), \
				PARTICLE_SIZE / STREAM_SIZE, \
				cudaMemcpyHostToDevice, way->stream[i]);
		}
		//将全局内存中线性存储模式的IV转换成矩形存储模式存储
		for (int i = 0; i < STREAM_SIZE; i++)
		{
...
void sm4_gcm_final(device_memory *way, uint64_t length, uint8_t tag[PARTICLE_SIZE])
{
	...
	length = (length / PARTICLE_SIZE) * 16;
	temp_len = (uint64_t)(length * 8); // len(C) = (uint64_t)(length*8)
	for (int i = 1; i <= 16 / 2; i++)
	{
